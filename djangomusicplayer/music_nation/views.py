...
def profile_detail(request, username):
    ...
    profile_fields = get_object_or_404(User, username=username)

    return render(request, 'music_nation/artist_detail.html', {'albums':albums, 'username':username, 'profile_fields':profile_fields})
